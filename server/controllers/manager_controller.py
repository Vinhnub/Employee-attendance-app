...
class ManagerController:
    ...
    def create_account(self, user_id, username, password, fullname, role, server):
    ...
    def delete_account(self, user_id, id):
    ...
    def get_all_shifts_today(self, user_id, server): # get list of shifts today
    ...
    def get_log_by_day(self, user_id, year, month, day):
        ...
        return {"status" : "fail", "message" : "Do not have permission or any log"}
